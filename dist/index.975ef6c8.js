...
searchBox.addEventListener("input", (0, _lodashDebounceDefault.default)(onInput, DEBOUNCE_DELAY));
function onInput(e) {
    ...
    (0, _fetchCountriesJsDefault.default)(inputValue).then((data)=>{
        if (data.length > 10) {
...
function markupCountryList(countries) {
    return countries.map(({ name , flags  })=>`<li class = list> 
...
function markupCountryInfo(country) {
    return country.map(({ name , capital , population , flags , languages  })=>{
        return `
        <h1 class="name"><img class = img src="${flags.svg} " alt="${name.official}" ${name.official}</h1>
...
},{"lodash.debounce":"3JP5n","notiflix":"5z0Oc","./fetchCountries.js":"fTQqv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./css/styles.css":"1CY4s"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"1CY4s":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequireabb0")
